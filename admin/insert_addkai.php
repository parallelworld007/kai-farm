...
<section class="content-header">
    <div class="small-box bg-gradient-olive">
        <div class="inner">
            <h3>เพิ่มข้อมูลเพิ่มไก่</h3>
            <p>ตารางเพิ่มข้อมูลการเพิ่มไก่</p>
        </div>
        <div class="icon">
            ...
            <?php
                ...
                <div class="row">
                    ...
                    <div class="col-8" style="margin:0.8rem 0 ;">
                        ...
                        <input type="text" class="form-control" name="mem_id" value="<?php echo $_SESSION['mem_id']; ?>" style="display: none;">
