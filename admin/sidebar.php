  ...
  <div class="sidebar">
    <div class="user-panel " style="padding: 1.5rem; ">
      <div class="info">
        ...
        <h6 class="text-teal " style="font-size: 20px; " >ระดับผู้ใช้งาน : ADMIN</h6>
      </div>
    </div>
    ...
    <nav class="mt-2">
      ...
      <ul class="nav nav-pills nav-sidebar nav-child-indent flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-header">ตั้งค่าข้อมูลผู้ใช้งาน</li>
        ...
        <li class="nav-item">
          <a href="list_cus.php" class="nav-link <?php if ($menu == "customer") {
                                                    echo "active";
                                                  } ?> ">
            <i class="nav-icon fa fa-users"></i>
            <p>Customer </p>
