...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="SL1.css">
  <style>body {
...
<a href="report1.php"><input type="button" value="รีเซ็ต"></a>
...
?>
      ...
      <h2>สีขาวฟาร์ม</h2>
        ...
        <div id="tables">
          ...
          <table id="chickenTable" width="10" border="1" cellspacing="0" cellpadding="5">
            <tr>
              <td width="200"><b>จำนวนลูกค้า</b></td>
              <td width="200">
                <div class="chart">
              ...
              <td width="200"><b>จำนวนพนักงาน</b></td>
              <td width="200">
                <div class="chart">
                  <h2 style="text-align: center;"><a>จำนวนลูกค้า</a></h2>
            ...
            <tr>
              <td width="200"><b>จำนวนโรงเรือน</b></td>
              <td width="200">
              ...
              <td width="200"><b>จำนวนโซนไก่</b></td>
              <td width="200">
                <table id="example" style="width:90%">
    ...
    JOIN zone ON house.hou_id = zone.hou_id";
            ...
            <tr>
              ...
              <td><b>ข้อมูลจำนวน เพิ่ม/ตาย/ขาย </b></td>
              <td>
                <?php
                include "db.php";
                ...
                <table>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo empty($row['adc_sell']) ? '-' : $row['adc_sell'] ?></td>
