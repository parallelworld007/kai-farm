...
<section class="content">
    <div class="card card-Light ">
        <div class="card-header ">
            <h3 class="card-title">รายการตรวจสอบการสั่งซื้อ</h3>
            <div align="right">
                ...
                <div class="col-md-12">
                    <table id="example" class="table table-striped table-bordered" style="width:70%" >
                        ...
                        <tbody>
                            ...
                            <?php
                           include("db.php");
                           $sql = "select * from order_head order by o_id";  //เรียกข้อมูลมาแสดงทั้งหมด
                           ...
                           while($row = mysqli_fetch_array($result)) {
                            ?>
                                <tr readonly>
                                    ...
                                    <td>
                                        <a href="orders.php?o_id=<?= $row['o_id']; ?>" class="link-Info">พิมพ์ใบสั่งซื้อ</a>
                                    </td>
