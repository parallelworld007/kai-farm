...
<div class="container">
    ...
    <div class="row" style="font-size: 16px; text-align: left; margin-left: 30px;">
        ...
        <span style="margin-right: 10px;">Total (เหลือ): <?php echo $adc_total_total; ?></span>
        <span style="margin-right: 10px;">Total (ตาย): <?php echo $adc_d_total; ?></span>
        <span>Total (ขาย): <?php echo $adc_sell_total; ?></span>
    </div>
