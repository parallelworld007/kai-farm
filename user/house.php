...
<section class="content">
    <div class="card card-Light ">
        <div class="card-header ">
            <h3 class="card-title"
            >รายการเพิ่มข้อมูล โรงเรือน</h3>
            <div align="right">
                
            <a href="printhouse.php" target="_blank">
    ...
    <?php
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if(mysqli_num_rows($result) > 0){
                        ...
                        $sql = "INSERT INTO `house`( `hou_name`,p_id) 
                        VALUES ('$hou_name','$p_id')";
                        $result = mysqli_query($conn, $sql);
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-8" style="margin:0.8rem 0 ;">
                            <label class="form-lable">โปรดัก</label>
                            <select name="p_id" class="form-control" readonly>
