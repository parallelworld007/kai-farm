      ...
      <?php
            ...
            if(isset($_POST['submit'])){
                ...
                if($sql){
                    ...
                    echo "</script>";
                    header("refresh:1 ; url=list_cus.php");
                }
                else{
                        ...
                        ?>               
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10" style="margin:0.8rem 0 ;">
                                            ...
                                            <select class="form-control select2" name="cus_gender" id="cus_gender" required>
                                    ...
                                    <br><button id="submit" name="submit" type="submit" class="btn btn-primary"><i class="fa fa-save"></i> ยืนยัน</button>
                                     <a href="list_cus.php" class="btn btn-danger">กลับ</a>
